...
public class Tileset {
    ...
    public static final TETile CAUGHT = new TETile('·', Color.orange, Color.black, "floor");
    ...
    public static final TETile HOME = new TETile('⛪', Color.yellow, Color.black, "home");
    public static final TETile ROBOT = new TETile('⛄', Color.red, Color.black, "robot");
    public static final TETile FOOD = new TETile('☕', Color.green, Color.black, "food");
}
